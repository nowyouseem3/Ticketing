...
const val getOpenTickets = "" +
        ...
        "co_assign_table.user_id = request_ticket_table.co_assign_id and " +
        "status_selector.status_code = ticket_status_table.ticket_status and " +
        "ticket_status_table.ticket_id = request_ticket_table.ticket_id and " +
        "status_selector.status_name = 'OPEN'"

const val getOnGoingTickets = "" +
        "SELECT " +
        "request_ticket_table.ticket_id, " +
        "status_name, " +
        "status_code, " +
        ...
        "status_selector.status_code = ticket_status_table.ticket_status and " +
        "ticket_status_table.ticket_id = request_ticket_table.ticket_id and " +
        "status_selector.status_name = 'ON GOING'"
